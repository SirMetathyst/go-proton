[![Build Status](https://travis-ci.org/SirMetathyst/go-proton.svg?branch=develop&dummy=unused)](https://travis-ci.org/SirMetathyst/go-proton?dummy=unused)  [![Coverage Status](https://coveralls.io/repos/github/SirMetathyst/go-proton/badge.svg?branch=develop&kill_cache=1)](https://coveralls.io/github/SirMetathyst/go-proton?branch=develop&kill_cache=1)  [![Go Report Card](https://goreportcard.com/badge/github.com/SirMetathyst/go-proton?dummy=unused)](https://goreportcard.com/report/github.com/SirMetathyst/go-proton?dummy=unused)
